...
(function (window, document, $) {
    ...
    var ultimaBarraIndex = rutaAbsoluta.lastIndexOf("/");

    // Obtener la parte de la URL que deseas
    var parteDeseada = rutaAbsoluta.substring(0, ultimaBarraIndex);
    ...
    i18next.use(window.i18nextXHRBackend).init(
        {
            ...
            backend: {
                loadPath:
                    parteDeseada + "/app-assets/data/locales/{{lng}}.json",
            },
            returnObjects: true,
        },
        function (err, t) {
