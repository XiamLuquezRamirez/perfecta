            ...
            <div class="row mb-1 mt-1 mt-md-0">
                <div class="col-6">
                    <div class="btn-group mr-1 mb-1 show">
                        <button type="button" class="btn btn-primary dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">Gestionar Cajas</button>
                        <div class="dropdown-menu show" x-placement="bottom-start" style="position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(0px, 41px, 0px);">
                            <a class="dropdown-item" href="#">Abrir Cajas</a>
                            <a class="dropdown-item" href="#">Cajas Cerras</a>
                            <div class="dropdown-divider"></div>
                            <a class="dropdown-item" href="#">Resumen de cajas</a>
                        </div>
                    </div>W
                </div>
                <div class="col-6">
